...
import mod.gottsch.fabric.gottschcore.block.BasedBlock;
 ...
 *
 */
public class NonCubeBasedBlock extends BasedBlock implements Waterloggable {
	 ...
	 *
	 */
	public NonCubeBasedBlock(AbstractBlock.Settings settings) {
		super(settings);
	...
	public BlockState getPlacementState(ItemPlacementContext context) {
		...
		BlockState blockState = this.getDefaultState().with(BASE, context.getSide());
