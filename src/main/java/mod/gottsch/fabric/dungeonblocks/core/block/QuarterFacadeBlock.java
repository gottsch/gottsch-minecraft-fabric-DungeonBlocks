...
public class QuarterFacadeBlock extends FacadeShapeBlock {
	...
	private static final VoxelShape NORTH_FACING_SHAPE = Block.createCuboidShape(0.0D, 0.0D, 12.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape EAST_FACING_SHAPE = Block.createCuboidShape(0.0D, 0.0D, 0.0D, 4.0D, 16.0D, 16.0D);
	private static final VoxelShape SOUTH_FACING_SHAPE = Block.createCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 4.0D);
	private static final VoxelShape WEST_FACING_SHAPE = Block.createCuboidShape(12.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);

	// outer corners
	private static final VoxelShape TOP_LEFT_OUTER_SHAPE = Block.createCuboidShape(12.0D, 0D, 12.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape TOP_RIGHT_OUTER_SHAPE = Block.createCuboidShape(0D, 0D, 12.0D, 4.0D, 16.0D, 16.0D);

	private static final VoxelShape BOTTOM_LEFT_OUTER_SHAPE = Block.createCuboidShape(12.0D, 0D, 0D, 16.0D, 16.0D, 4.0D);
	private static final VoxelShape BOTTOM_RIGHT_OUTER_SHAPE = Block.createCuboidShape(0D, 0D, 0D, 4.0D, 16.0D, 4.0D);

	// inner corners
	private static final VoxelShape TOP_LEFT_INNER_SHAPE = VoxelShapes.union(SOUTH_FACING_SHAPE,
			Block.createCuboidShape(0.0D, 0D, 4.0D, 4.0D, 16.0D, 16.0D));
	private static final VoxelShape TOP_RIGHT_INNER_SHAPE =  VoxelShapes.union(SOUTH_FACING_SHAPE,
			Block.createCuboidShape(12.0D, 0D, 4.0D, 16.0D, 16.0D, 16.0D));

	private static final VoxelShape BOTTOM_LEFT_INNER_SHAPE =  VoxelShapes.union(NORTH_FACING_SHAPE,
			Block.createCuboidShape(0.0D, 0D, 0.0D, 4.0D, 16.0D, 12.0D));
	private static final VoxelShape BOTTOM_RIGHT_INNER_SHAPE =  VoxelShapes.union(NORTH_FACING_SHAPE,
			Block.createCuboidShape(12.0D, 0D, 0D, 16.0D, 16.0D, 12.0D));
	 ...
	 * @param properties
	 */
	public QuarterFacadeBlock(AbstractBlock.Settings properties) {
		super(properties);
	}
