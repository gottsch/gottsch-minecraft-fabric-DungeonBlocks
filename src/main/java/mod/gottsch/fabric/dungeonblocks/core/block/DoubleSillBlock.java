...
public class DoubleSillBlock extends NonCubeFacingBlock {
	...
	private static final VoxelShape NORTH_SOUTH_AABB = Block.createCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 12.0D, 16.0D);
	private static final VoxelShape EAST_WEST_AABB = Block.createCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 12.0D, 16.0D);
	
	/**
	 * 
	 * @param properties
	 */
	public DoubleSillBlock(AbstractBlock.Settings properties) {
		super(properties);
	}
